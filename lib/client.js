window.__ModuleLoader__.load({
	id: "@dsh-community/dsh-plugin-repoflow",
	factory: (require) => {
		var module = { exports: {} };
...
`;
		...
		function apply(ctx) {
			...
			style.dataset.plugin = "@dsh-community/dsh-plugin-repoflow";
			style.dataset.pluginCss = "@dsh-community/dsh-plugin-repoflow/styles";
